...
function SocialLinksCard() {
  return (
    <div className="flex flex-col justify-center items-center rounded-lg bg-Grey-Mid w-fit p-8">
      ...
      <h1 className="text-white font-inter font-semibold text-xl">Franco Gomez Rosell</h1>
      ...
      <ul className="w-full flex flex-col justify-center items-center gap-3">
        <li className="bg-Grey-Light w-full text-white font-inter font-semibold text-center text-sm py-2 rounded-md hover:bg-Green hover:text-Grey-Mid">
